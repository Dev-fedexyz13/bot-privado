...
let handler = async (m, { conn}) => {
  ...
  // 🧠 Detectar si es el bot oficial
  const botOficial = global.botname?.includes('Obito-Bot_MD') || conn.user?.id?.includes('obito') || conn.user?.jid?.includes('obito');

  if (!botOficial) {
    return m.reply(`${emojiError} 𝖤𝗌𝗍𝖾 𝖼𝗈𝗆𝖺𝗇𝖽𝗈 𝖾𝗌 𝖾𝗑𝖼𝗅𝗎𝗌𝗂𝗏𝗈 𝖽𝖾𝗅 𝖡𝗈𝗍 𝖮𝖿𝗂𝖼𝗂𝖺𝗅.\n🕷️ 𝖫𝗈𝗌 𝗌𝗎𝖻𝖻𝗈𝗍𝗌 𝗇𝗈 𝗉𝗎𝖾𝖽𝖾𝗇 𝖾𝗃𝖾𝖼𝗎𝗍𝖺𝗋 𝖺𝖼𝗍𝗎𝖺𝗅𝗂𝗓𝖺𝖼𝗂𝗈𝗇.`);
}
